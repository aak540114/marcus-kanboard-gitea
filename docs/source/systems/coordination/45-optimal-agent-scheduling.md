...
class LearningEnhancedScheduler:
    async def calculate_optimal_agents(self, tasks: List[Task]) -> ProjectSchedule:
        ...
        historical_data = await self.learning_service.get_similar_projects(
