...
Currently, the Core Models system does not have direct dashboard integration, as this appears to be a future enhancement. However, the models are designed to support AI coaching systems through:
