...
The Workspace Isolation system provides security context to the dashboard's Context Bridge:
...
When the dashboard propagates context between related tasks, workspace security boundaries are maintained:
...
The dashboard's memory system respects workspace boundaries:
