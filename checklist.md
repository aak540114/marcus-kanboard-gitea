...
- [ ] [Enhancement] Project deletion UI — unified delete across the dashboard, ProjectRegistry, and kanban providers (#256) 🔴
...
- [ ] [Feature] Living Architecture Diagram — real-time IDEA flow with drill-down and GIF export (#378) 🟡
